  ...
  render(){
    return (
      <ScrollView style={styles.container}>
        ...
        <Text style={{fontSize:16,fontWeight:'600',paddingHorizontal:10,paddingVertical:5,textAlign: 'justify'}}>Movement is important to maintain wellbeing. Exercise in FND, needs to be graded to meet 
        ...
        <Text style={{fontSize:16,fontWeight:'600',paddingHorizontal:10,paddingVertical:5,textAlign: 'justify'}}>Many people in FND, will have lost their automatic movements. Physical movements such as 
          ...
          at hand.</Text>
        <Text style={{fontSize:16,fontWeight:'600',paddingHorizontal:10,paddingVertical:5,textAlign: 'justify'}}>The ability to access normal movement while distracted, is a diagnostic sign of FND, and is 
          also used in treatment, to facilitate normal movement.</Text>
        <Text style={{fontSize:16,fontWeight:'600',paddingHorizontal:10,paddingVertical:5,textAlign: 'justify'}}>When people experience functional movement disorder, they should work with their health 
          practitioner, to design a movement program that meets their specific and individual needs.</Text>
        <Text style={{fontSize:16,fontWeight:'600',paddingHorizontal:10,paddingVertical:5,textAlign: 'justify'}}>Physical activities that can support wellbeing in FND include hydrotherapy, trauma sensitive 
